...
/**
 * A node_old in a graph. To be more precise, a node_old is an graphical entity that represents a class, a sequence, a
 * state or all other type of entities that can or not handle edges.
 *
...
public interface INode extends Serializable, Cloneable, IIdentifiable, ConnectedEdgeListener {
    ...
    /**
     * Get the best connection point to connect this node_old with another node_old. This should be a point on the
     * boundary of the shape of this node_old.
     *
    ...
    /**
     * @return LineText contains Node name
     */
    LineText getName();
